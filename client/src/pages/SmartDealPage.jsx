...
//     setLoading(true);
//     setCurrentStep(3); // Set step to "View Analysis" when generating recommendation
...
//         // Update chart data and recommendation
//         setChartData({
...
//     if (currentStep === 1) setCurrentStep(2); // Move to "Generate Recommendation" step after input
//   };

//   return (
//     <div className="flex flex-col font-sans">
//       {/* Dynamic Header with Steps Indicator */}
//       <header className="text-center py-4 bg-gray-200 text-gray-800">
//         <h3 className="text-xl font-semibold">Smart Deal Recommendation</h3>
//         <div className="flex justify-center space-x-6 mt-2">
//           <div className={`${currentStep === 1 ? 'text-blue-600 font-bold' : 'text-gray-500'}`}>
//             1. Enter Details
//           </div>
//           <span className="text-gray-500">→</span>
//           <div className={`${currentStep === 2 ? 'text-blue-600 font-bold' : 'text-gray-500'}`}>
//             2. Generate Recommendation
//           </div>
//           <span className="text-gray-500">→</span>
//           <div className={`${currentStep === 3 ? 'text-blue-600 font-bold' : 'text-gray-500'}`}>
//             3. View Analysis
//           </div>
//         </div>
//       </header>
...
//               <h2 className="text-2xl font-bold mb-4">Deal Analysis Report</h2>
//               <p className="text-lg font-semibold mb-4">
//                 {isRecommended ? (
//                   <span className="text-green-600">This is a recommended deal! 🎉</span>
//                 ) : (
//                   <span className="text-red-600">This deal may not meet your profit expectations.</span>
//                 )}
//               </p>
