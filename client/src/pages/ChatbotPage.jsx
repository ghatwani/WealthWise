...
const ChatBot = () => {
  ...
  return (
    <div className="flex bg-gradient-to-r from-teal-500 via-cyan-600 to-blue-700 min-h-screen flex-col px-4">
      {/* Chat Header */}
      <div
        className="flex justify-between items-center bg-gradient-to-r from-teal-600 via-cyan-700 to-blue-800 text-white p-6 rounded-lg shadow-md mb-4"
        data-aos="fade-down"
      >
        <button
      ...
      {showWelcome && (
        ...
        >
          ...
          <p className="text-lg mb-8">
            Ask me anything related to managing your budget and finances!
          </p>
          <p className="text-sm">
            Your conversation will begin once you send your first message.
          </p>
        </div>
      )}
      ...
      {showPrompts && (
        ...
        >
          ...
          <div
            className="bg-teal-800 text-white rounded-full py-2 px-4 cursor-pointer hover:bg-teal-700 transition-all"
            onClick={() =>
              setMessage("Tell me about the best investment strategies.")
            }
          >
      ...
      <div className="flex-1 overflow-auto p-4 space-y-6 flex flex-col">
        {messages.map((msg, index) => (
          <div
            key={index}
            className={`chat-bubble p-4 rounded-lg max-w-[75%] ${
              msg.sender === "user"
            ...
            <div className="flex items-center space-x-2">
              <div
                className={`w-8 h-8 rounded-full ${
                  msg.sender === "user" ? "bg-teal-800" : "bg-gray-300"
